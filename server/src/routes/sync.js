      ...
      try {
        if (change.entity === 'sale') {
          ...
          if (change.operation === 'create' || change.operation === 'update') {
            ...
            await Product.findByIdAndDelete(change.entityId);
          }
          results.push({ id: change.id, status: 'ok' });
          ...
          if (change.operation === 'create' || change.operation === 'update') {
            ...
            await Customer.findByIdAndDelete(change.entityId);
          }
          results.push({ id: change.id, status: 'ok' });
          ...
          if (change.operation === 'create' || change.operation === 'update') {
            ...
            await Category.findByIdAndDelete(change.entityId);
          }
          results.push({ id: change.id, status: 'ok' });
          ...
          if (change.operation === 'create' || change.operation === 'update') {
            ...
            await Supplier.findByIdAndDelete(change.entityId);
          }
          results.push({ id: change.id, status: 'ok' });
        }
      } catch (err) {
